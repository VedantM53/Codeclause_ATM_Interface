		   ...
		   if (user1 != null && user1.getAccountno() != 0) {
	            ...
	            if (existingUser != null) {
	                ...
	                if (amount1 <= currentBalance) {
	                    ...
	                    existingUser.setWithdraw(amount1);
	                    ...
	                    pw.println("-----Withdrawal successful-----");
	                    pw.println("New balance: " + existingUser.getBalance());
	                	...
	                	PrintWriter pw=resp.getWriter();
	                    pw.println("Insufficient funds. Current balance: " + currentBalance);
	                    RequestDispatcher rd=req.getRequestDispatcher("User_Module.html");
	                    rd.include(req, resp);
	                    resp.setContentType("text/html");
	                }
